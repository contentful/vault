...
```groovy
apt 'com.contentful.vault:compiler:3.2.2'
compile 'com.contentful.vault:core:3.2.2'
```
* _Gradle 3.+_
```groovy
annotationProcessor 'com.contentful.vault:compiler:3.2.2'
annotationProcessor 'com.contentful.vault:core:3.2.2'
compile 'com.contentful.vault:core:3.2.2'
```
